...
/******/
/******/ 		var wasmModules = {"0":["./tantivy_wasm_bg.wasm"]}[chunkId] || [];
/******/
...
/******/ 				(installedWasmModules[wasmModuleId] = fetch(__webpack_require__.p + "" + {"./tantivy_wasm_bg.wasm":"723ce7ccf5eff89651ed"}[wasmModuleId] + ".module.wasm").then(function(response) {
